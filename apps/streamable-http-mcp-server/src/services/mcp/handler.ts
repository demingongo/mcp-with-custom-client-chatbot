...
function success(id: JsonRpcId | undefined, result: unknown): JsonRpcSuccessResponse {
  return { jsonrpc: "2.0", id, result };
}

function rpcError(id: JsonRpcId | undefined, code: number, message: string): JsonRpcErrorResponse {
...
function handleToolsCall(id: JsonRpcId | undefined, params: unknown, session: Session): JsonRpcResponse {
